...
from dataset.util.humanml3d.data.dataset import collate_fn
from collections import OrderedDict
from dataset.util.humanml3d.util.utils import *
        ...
        while epoch < self.opt.max_epoch:
            ...
            for i, batch_data in enumerate(train_dataloader):
                ...
                if it % self.opt.log_every == 0:
                    ...
                    logs = OrderedDict()
                    print(start_time, it, total_iters, mean_loss, epoch, i)
                ...
                for i, batch_data in enumerate(train_loader):
                    ...
                    if it % self.opt.log_every == 0:
                        ...
                        for tag, value in logs.items():
                            ...
                            mean_loss[tag] = value / self.opt.log_every
                        logs = OrderedDict()
                        print(start_time, it, mean_loss, epoch, sub_epoch=sub_epoch, inner_iter=i,
